# The makefile below works for Momentics IDE.
...
# The makefile below works for all other cases.
...
# Controller:	Controller.o $(OBJFILES)
	# $(CXX) $(CXXFLAGS) -o Controller Controller.o $(OBJFILES) $(CCLIBFLAGS)
